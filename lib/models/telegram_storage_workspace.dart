...
class TelegramStorageWorkspace {
  ...
  bool get hasCatalogChannel => catalogChannel != null;
  bool get hasFilesChannel => filesChannel != null;
  bool get isFullyConfigured => catalogChannel != null && filesChannel != null;
  bool get usesSameChannel =>
      catalogChannel != null &&
      filesChannel != null &&
      catalogChannel!.id == filesChannel!.id;
  ...
  TelegramStorageWorkspace copyWith({
    ...
    return TelegramStorageWorkspace(
      catalogChannel: clearCatalogChannel
          ? null
          : catalogChannel ?? this.catalogChannel,
      filesChannel:
          clearFilesChannel ? null : filesChannel ?? this.filesChannel,
    );
  }
  ...
  factory TelegramStorageWorkspace.fromJson(Map<String, dynamic> json) {
    TelegramStorageChannel? readChannel(dynamic raw) {
    ...
    return TelegramStorageWorkspace(
      catalogChannel: readChannel(json['catalogChannel']),
      filesChannel: readChannel(json['filesChannel']),
    );
  }
}
